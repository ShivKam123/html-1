...
<body>
    ...
    <center>
        ...
        $m->close();
        ?>
    <form action="http://localhost/Lena Bank/Edeposit2.php" method="post" style="margin-bottom: -10px; font-size: 20px;" >
            <table>
                <tr>
    ...
    <br><hr><div class="back"><a href="Edeposit.php"><b><big><strong>Back</strong></big></b></a></div>
    </div>
</body>
</html>