...
<body>
    <center>
        ...
        <div class="from">
            <form action="http://localhost/Lena Bank/SA.php" name="fm" onsubmit="return valid();">
            <h2>Please Select the Branch where you want to open the account</h2>
            <hr>
            <h4 style="margin-bottom: -10px;"><center><b><big><strong>Saving Account Form</strong></big></b></center></h4>
            <table>
            <tr>
