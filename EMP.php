...
<body>
    <center>
        ...
        <div class="from">
            <form action="http://localhost/Lena Bank/EMP1.php" name="fm" onsubmit="return valid();">
            <h2>Please Select the Branch where you want to open the account</h2>
            <hr>
            <h4 style="margin-bottom: -10px;"><center><b><big><strong>Employee Account Form</strong></big></b></center></h4>
            <table>
            <tr>
    ...
    <script>
        function valid()
        {
            ...
            if(document.fm.cmn.value == "" || document.fm.cmn.value.length != 10)
            {
            ...
            if(document.fm.username.value == "" || document.fm.username.value.length < 6)
            {
                document.fm.username.focus();
                alert("Please Enter Username");
                return false;
            }
            if(document.fm.password.value == "" || document.fm.username.value.length < 6)
            {
